  ...
  initializeCharts() {
    ...
    get categorizedLimits() {
        ...
        this.limits.forEach(limit => {
            ...
            else if (name.includes('storage') || name.includes('content')) categories.Storage.push(limitWithStyle);
            else if (name.includes('event') || name.includes('stream')) categories.PlatformEvents.push(limitWithStyle);
            else if (name.includes('email')) categories.Email.push(limitWithStyle);
            else if (name.includes('dashboard') || name.includes('report')) categories.ReportsDashboards.push(limitWithStyle);
            else if (name.includes('einstein') || name.includes('analytics')) categories.Analytics.push(limitWithStyle);
            else if (name.includes('apex') || name.includes('workflow')) categories.AsyncApex.push(limitWithStyle);
            else if (name.includes('metadata') || name.includes('package')) categories.MetadataDeploy.push(limitWithStyle);
